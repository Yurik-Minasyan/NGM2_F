    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lw.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(id == 0 || id == 1 |id == 2 ||id == 15 ||id == 16 ||id == 17 || id == 30 ||id == 31 ||id == 32){
                    Intent i = new Intent(Salad.this, naxutest.class);
                    startActivity(i);
                }
                ...
                if(id == 6 || id == 7 ||id == 8 |id == 21 ||id == 22 || id == 33 ||id == 36 ||id == 37 ||id == 38){
                    Intent i = new Intent(Salad.this, Fast_Food.class);
                    startActivity(i);
                }
                if(id == 9 ||id == 10 ||id == 11 ||id == 24 ||id == 25 || id == 26 ||id == 39 ||id == 40 ||id == 41){
                    Intent i = new Intent(Salad.this, Coffee.class);
                    startActivity(i);
                }
                if(id == 12 || id == 13 ||id == 14 ||id == 27 ||id == 28 || id== 29 ||id == 46 ||id == 47 ||id == 48){
                    Intent i = new Intent(Salad.this, cakes.class);
                    startActivity(i);
                }
                if(id == 42 || id == 43 ||id == 44 ||id == 45 || id == 49 || id == 50){
                    Intent i = new Intent(Salad.this, Drint.class);
                    startActivity(i);
                }
            }
        });
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Salad.this, Orders.class);
                startActivity(i);
